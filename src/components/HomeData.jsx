...
//   return (
//     <>
//       <div className="content bg-gray-200 w-screen h-screen flex flex-col justify-center items-center relative">
//         <h1 className="text-7xl font-bold text-gray-600">Anjana Bhattrai</h1>
//         <p className="text-sm text-gray-500 pt-2">
//           React | Python | js (web developer / frontend developer)
//         </p>
//         <Link
//           to="/thirty-min-meeting"
//           className="bg-white rounded-xl w-1/3 h-32 shadow-xl p-4 px-6 mt-24 flex flex-col justify-center hover:bg-green-200 cursor-pointer"
//           // onClick={handlePopup}
//         >
//           <p>30 min meeting</p>
...
//         <Link
//           to="sixty-min-meeting"
//           className="bg-white rounded-xl w-1/3 h-32 shadow-xl p-4 px-6 mt-4 flex flex-col justify-center hover:bg-green-200 cursor-pointer mb-12"
//         >
//           <p>60 min meeting</p>
//           <div className="flex space-x-2">
